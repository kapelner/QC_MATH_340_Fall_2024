...
\newcommand{\professorcontactinfo}{kapelner@gmail.com}
...
\newcommand{\numcredits}{4}
\newcommand{\lectimeandloc}{Tues/Thurs 3:45-5:35PM / KY258}
\newcommand{\requiredlabtimeandloc}{}
\newcommand{\tataofficehourtimeandloc}{Elliot Gangaram / see \coursewebpagelink} 
\newcommand{\numtheoryhws}{6--9}
\newcommand{\lastdatetimetohandinhomeworks}{Dec 13 at noon}
%\newcommand{\midtermonedateandlocation}{see \coursewebpagelink}
%\newcommand{\midtermtwodateandlocation}{see \coursewebpagelink}
%\newcommand{\finaldateandlocation}{see \coursewebpagelink}
...
\paragraph{Textbook:} Introduction to Probability Theory by Hoel, Port \& Stone. This book is out of print but you can buy it used on \href{https://www.amazon.com/Introduction-Probability-Theory-Paul-Hoel/dp/039504636X/ref=sr_1_1?ie=UTF8&qid=1503515517&sr=8-1&keywords=introduction+to+probability+theory+hoel}{Amazon} for less than \$20 (as far as textbooks go). There is no excuse not to have this book. It is \textit{required}. However, I will not ususally be teaching \qu{from the book} --- most of the material in the class comes from the lecture notes. The textbook is a way to get ``another take'' on the material. The textbook covers about only half of the material done in class (yes, sometimes we will be following the textbook page by page). For the other half, you will have to make use of other resources.
...
This is a four credit course. Thus, the amount of work outside of the 4hr in-class time per
week is 8-10 hours per the QC bulletin. I will aim for 9hr of homework per week on average. However, doing the homework well is your sole responsibility since I will make sure that by doing the homework you will study and understand the concepts in the lectures and you won't have all that much to do when the exams roll around.
