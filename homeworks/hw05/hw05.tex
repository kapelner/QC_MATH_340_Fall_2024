...
\date{Due by email 11:59PM November 10, \the\year \\ \vspace{0.5cm} \small (this document last updated \today ~at \currenttime)}
}
...
\hardsubproblem{Let $W^2 \sim F_{1, k}$ where $k \in \naturals$. Find the PDF of $W$, $f_W(w)$, by using transformation of variables.}

\ingreen{
As this question caused confusion in previous years, I will start you off... 
\beqn
